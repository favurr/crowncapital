...
import CoinsPagination from "@/components/reusables/coins-pagination";
...
const Coins = async ({ searchParams }: NextPageProps) => {
  ...
  const coinsData: CoinMarketData[] = (await fetcher<CoinMarketData[]>("/coins/markets", {
    vs_currency: "usd",
  ...
  const columns: DataTableColumn<CoinMarketData>[] = [
    {
      ...
      cell: (coin) => (
        <>
          ...
          <Link href={`/console/coins/${coin.id}`} aria-label="View coin" />
        </>
      ),
    },
    {
